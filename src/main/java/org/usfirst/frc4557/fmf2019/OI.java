...
public class OI {
    ...
    public XboxController playstayController = new XboxController(0);

    public OI() {
        
        
        //JoystickButton climberUp = new JoystickButton(leftJoystick, 1);
        //climberUp.whenPressed(new ClimberUp());
        //JoystickButton climberDown = new JoystickButton(leftJoystick, 0);
